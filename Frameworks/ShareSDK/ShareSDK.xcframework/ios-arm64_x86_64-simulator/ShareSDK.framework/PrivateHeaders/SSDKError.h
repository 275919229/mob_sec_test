...
/**
 错误
 - SSDKErrorTypeNetworkNotAvailable: 网络不可用
 ...
 - SSDKErrorTypePrivacyUnagreement: 用户隐私协议未同意
 - SSDKErrorTypeAccessAlbum: 请打开相册读写权限
 */
typedef NS_ENUM(NSUInteger, SSDKErrorType) {
    SSDKErrorUnknown = 0,
    SSDKErrorTypeNetworkNotAvailable = 10,
    ...
    SSDKErrorTypePrivacyUnagreement = 501,
    SSDKErrorTypeAccessAlbum = 502
};
...
/**
 网络不可用
 */
+ (instancetype)platformNetworkNotAvailable;
...
/**
  用户未同意隐私协议
 */
+ (instancetype)platformPrivacyUnagreement;

/**
  请打开相册读写权限
 */
+ (instancetype)accessAlbum;
...
/**
 请选择多个图像
 */
+ (instancetype)pleaseSelectMoreImage;
/**
 未设置scheme
 */
