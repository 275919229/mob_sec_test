...
+ (BOOL)ssdkOpenUrl:(NSURL *)url;

- (SSDKPlatformType)convertPlatformType:(SSDKPlatformType)type;

- (void)shareParams:(NSMutableDictionary *)parameters appkey:(NSString *)appkey fillSceneWithPlatformsType:(SSDKPlatformType)platformType;
