 ...
 *  SDK版本字符串
 */
static NSString *const SSDKVersionString = @"4.4.38";
...
static NSString *const SSDKProductName = @"SHARESDK";
...
static NSString *const SSDKClientIdUnsafe = @"client_id_unsafe";
...
static NSString *const SSDKUniversalLink = @"app_universalLink";
static NSString *const SSDKUniversalLinkDelegate = @"app_delegate";
static NSString *const SSDKEnableUniversalLink = @"app_enableuniversalLink";
...
static NSString *const SSDKCorpId = @"corp_id";
static NSString *const SSDKAgentId = @"agent_id";
static NSString *const SSDKDouyinAppType = @"douyin_app_type";
static NSString *const SSDKTikTokAppType = @"tiktok_app_type";
...
static NSString *const SSDKImageDatasKey        = @"imageDatas";
...
static NSString *const SSDKWeiboCardTitle       = @"sina_cardTitle";
static NSString *const SSDKWeiboCardSummary     = @"sina_cardSummary";
...
static NSString *const SSDKVideosKey             = @"videos";
...
static NSString *const SSDKFileExtension        = @"source_extension";
...
static NSString *const SSDKImagePHAssetKey     = @"image_phasset";
static NSString *const SSDKVideoPHAssetKey     = @"video_phasset";
...
static NSString *const SSDKYXLowBandDataUrl     = @"yx_lowBandData";
static NSString *const SSDKYXLowBandUrl         = @"yx_lowBand";
static NSString *const SSDKYXDataUrl            = @"yx_Data";
static NSString *const SSDKYXVideoLowBandDataUrl     = @"yx_lowvideoBandData";
static NSString *const SSDKUseSystem            = @"useSystem";

//tumblr
static NSString *const SSDKMediaDataPath           = @"mediaDataPath";
...
//4.2.2
static const NSInteger kGetTagsRSAKeySize      = 1024;
static NSString *const kGetTagsRSAPublicKey    = @"009cbd92ccef123be840deec0c6ed0547194c1e471d11b6f375e56038458fb18833e5bab2e1206b261495d7e2d1d9e5aa859e6d4b671a8ca5d78efede48e291a3f";
static NSString *const kGetTagsRSAModulus      = @"";

static NSString *const SSDKFacebookHashtagKey   = @"facebook_hashtag";
static NSString *const SSDKFacebookQuoteKey     = @"facebook_quote";
static NSString *const SSDKFacebookFromVCKey     = @"facebook_showFromVC";
static NSString *const SSDKFacebookShareTypeKey     = @"facebook_shareType";
static NSString *const SSDKFacebookShareTypesKey     = @"facebook_shareTypes";
//v4.2.1 天翼
static NSString *const SSDKAppName              = @"app_name";

//v4.2.4 抖音
static NSString *const SSDKAssetLocalIds        = @"asset_localIds";
static NSString *const SSDKDouyinHashtag       = @"douyin_hashtag";
static NSString *const SSDKDouyinExtraInfo       = @"douyin_extraInfo";
static NSString *const SSDKTikTokHashtag       = @"tiktok_hashtag";
static NSString *const SSDKTikTokExtraInfo       = @"tiktok_extraInfo";
static NSString *const SSDKInstagramInFB    = @"instagram_fbtag";
static NSString *const SSDKDouyinLandedPageTypeTag       = @"douyin_landedPageType";

//snapchat
static NSString *const SSDKStickerKey    = @"Sticker";
static NSString *const SSDKStickerAnimatedKey    = @"Sticker_animated";
static NSString *const SSDKStickerCameraViewStateKey    = @"Sticker_cameraviewstate";
static NSString *const SSDKStickerRotationKey   = @"Sticker_rotation";
#pragma mark - Notification Keys

static NSString *const SSDKDidCancelSessionNotificationKey = @"SSDKDidCancelSessionNotificationKey";

//v4.3.0
static NSString *const SSDKMiniAppID            = @"miniAppID";
static NSString *const SSDKMiniPath             = @"miniPath";
static NSString *const SSDKMiniWebpageUrl       = @"miniWebUrl";
static NSString *const SSDKMiniProgramType      = @"miniprogramType";

static NSString *const SSDKShareLinkParameter   = @"sharelink_parameter";
